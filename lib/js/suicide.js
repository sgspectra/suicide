...
function guessInsideOrOutside(guess){
	...
	if (turn === players.length) {
		round++;
		turn = 0;
		$("#actionButtons").html("<button class=\"btn btn-default\" type=\"button\" id=\"diamond\" onclick=\"suicide.guessSuit();\">Diamonds</button><button class=\"btn btn-default\" type=\"button\" id=\"heart\" onclick=\"suicide.guessSuit();\">Hearts</button><button class=\"btn btn-default\" type=\"button\" id=\"club\" onclick=\"suicide.guessSuit();\">Clubs</button><button class=\"btn btn-default\" type=\"button\" id=\"spade\" onclick=\"suicide.guessSuit();\">Spades</button>");
	}
