...
$(document).ready(function(){
	$("#startGame").on('click', function(){
        ...
        $("#drink-picker div.modal-body").html(playerButtonsTemplate({
            'players' : players
        }));
	});	
});
...
function giveDrinksTo(drinks){
    // Update table count
    var count = parseInt($('.p' + turn + '-given').text(), 10) + drinks;
    ...
    // Render instruction
    $("#instructions").html("<p>Give " + drinks + " drinks.</p>");
