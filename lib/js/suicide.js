...
$(document).ready(function(){
	$("#startGame").on('click', function(){
		...
		$("#actionButtons").html("<button class=\"btn btn-default\" type=\"button\" id=\"red\" onclick=\"guessRedOrBlack('red');\">Red</button><button class=\"btn btn-default\" type=\"button\" id=\"black\" onclick=\"guessRedOrBlack('black');\">Black</button>");
	});	
});
...
function guessRedOrBlack(guess){
	...
	if (turn === players.length){
		round++;
		turn = 0;
        $("#actionButtons").html("<button class=\"btn btn-default\" type=\"button\" id=\"higher\" onclick=\"guessHigherOrLower('higher');\">Higher</button><button class=\"btn btn-default\" type=\"button\" id=\"lower\" onclick=\"guessHigherOrLower('lower');\">Lower</button>");
	}
...
function guessHigherOrLower(guess){
	...
	if (turn === players.length) {
		round++;
		turn = 0;
		$("#actionButtons").html("<button class=\"btn btn-default\" type=\"button\" id=\"inside\" onclick=\"guessInsideOrOutside('inside');\">Inside</button><button class=\"btn btn-default\" type=\"button\" id=\"outside\" onclick=\"guessInsideOrOutside('outside');\">Outside</button>");
	}
...
function guessInsideOrOutside(guess){
	...
	if (turn === players.length) {
		round++;
		turn = 0;
		$("#actionButtons").html("<button class=\"btn btn-default\" type=\"button\" id=\"diamond\" onclick=\"guessSuit();\">Diamond</button><button class=\"btn btn-default\" type=\"button\" id=\"heart\" onclick=\"guessSuit();\">Heart</button><button class=\"btn btn-default\" type=\"button\" id=\"club\" onclick=\"guessSuit();\">Club</button><button class=\"btn btn-default\" type=\"button\" id=\"spade\" onclick=\"guessSuit();\">Spade</button>");
	}
