...
function guessHigherOrLower(guess){
	...
	if (turn === players.length) {
		round++;
		turn = 0;
		$("#actionButtons").html("<button type=\"button\" id=\"inside\" onclick=\"guessInsideOrOutside('inside');\">Inside</button><button type=\"button\" id=\"outside\" onclick=\"guessInsideOrOutside('outside');\">Outside</button>");
	}
...
function guessInsideOrOutside(guess){
	...
	if (turn === players.length) {
		round++;
		turn = 0;
		$("#actionButtons").html("<button type=\"button\" id=\"diamond\" onclick=\"guessSuit();\">Diamond</button><button type=\"button\" id=\"heart\" onclick=\"guessSuit();\">Heart</button><button type=\"button\" id=\"club\" onclick=\"guessSuit();\">Club</button><button type=\"button\" id=\"spade\" onclick=\"guessSuit();\">spade</button>");
	}
