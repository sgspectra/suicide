...
$(document).ready(function(){
	$("#startButton").click(function(){
		...
		$("#actionButtons").html("<button type=\"button\" id=\"red\" onclick=\"guessRed();\">Red</button>
		<button type=\"button\" id=\"black\" onclick=\"guessBlack();\">Black</button>");
	});	
});
...
function guessRed(){
	...
	if(turn === players.length){
		round++;
		turn = 0;
		$("#actionButtons").html("<button type=\"button\" id=\"higher\" onclick=\"guessHigher();\">Higher</button>
		<button type=\"button\" id=\"lower\" onclick=\"guessLower();\">Lower</button>");
	}
...
function guessHigher(){
	...
	if(turn === players.length){
		round++;
		turn = 0;
		$("#actionButtons").html("<button type=\"button\" id=\"inside\" onclick=\"guessInside();\">Inside</button>
		<button type=\"button\" id=\"outside\" onclick=\"guessOutside();\">Outside</button>");
	}
}
